...
{#if browser && !isOnline.value}
	<div
		class="fixed top-0 right-0 left-0 z-50 flex items-center justify-center gap-2 bg-amber-500 px-4 py-2 text-sm font-medium text-white shadow-md"
	>
...
{#if swUpdateAvailable}
	<div
		class="fixed top-0 right-0 left-0 z-50 flex items-center justify-center gap-3 bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-md"
