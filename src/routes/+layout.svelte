...
{#if !$isOnline}
    <div
                class="fixed inset-x-0 top-0 z-50 flex items-center justify-center gap-2 bg-amber-500 px-4 py-2 text-center text-sm font-medium text-white shadow-lg"
            >
                <span class="inline-block size-2 rounded-full bg-white" aria-hidden="true"></span>
